 ...
 */
define('PDF_HEADER_LOGO', 'tc.jpg');

/**
 * Header logo image width in user units.
 */
define('PDF_HEADER_LOGO_WIDTH', 26);
 ...
 * Header title.
 */
define('PDF_HEADER_TITLE', 'PERUMDA AIR MINUM TIRTO PANGURIPAN KABUPATEN KENDAL');

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "Jl. Pemuda No.62, Kebondalem, Langenharjo, Kec. Kendal, Kabupaten Kendal, Jawa Tengah 51314");
