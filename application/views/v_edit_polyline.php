<div class="card-body">
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <div class="form-group">
                <label>GeoJSON</label>
                <textarea name="geojson" rows="4" class="form-control" readonly><?= $polyline->geojson ?></textarea>
            </div>
            <div class="form-group">
                <label>Diameter</label>
                <input name="diameter" value="<?= $polyline->diameter ?>" placeholder="Diameter" type="text" class="form-control">
            </div>
            <div class="form-group">
                <label>Color</label>
                <div class="input-group my-colorpicker2">
                    <input type="text" value="<?= $polyline->color ?>" name="color" class="form-control" readonly />
