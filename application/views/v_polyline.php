<a href="<?= base_url('polyline/add') ?>" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Add Data</a>
<div class="card-body">
            ...
            foreach ($polyline as $key => $value) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($value->status == 'Diproses') : ?>
                            <a href="<?= base_url('polyline/status/' . $value->id) ?>" class="btn btn-sm btn-success btnChangeStatus"><i class="fas fa-check"></i></a>
                        <?php endif; ?>
                        <a href="<?= base_url('polyline/edit/' . $value->id) ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                        <a href="<?= base_url('polyline/delete/' . $value->id) ?>" class="btnDelete btn btn-sm btn-danger" on-click="return confirm('Apakah Anda Yakin Ingin Hapus Data ini..?')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
