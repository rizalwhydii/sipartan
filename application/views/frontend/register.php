            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <?php echo form_error('confirm_password', '<p class="text-danger mb-0" style="font-size: small;">', '</p>'); ?>
                    </div>
                    <div class="row">
                        <!-- /.col -->
                        <div class="col">
                            <button type="submit" class="btn btn-block text-white" style="background-color: #49548E;">Register</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
                <p class="mt-3">
                    <a href="<?= base_url('frontend/login'); ?>" class="mt-5 text-center">I already have a membership</a>
                </p>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
